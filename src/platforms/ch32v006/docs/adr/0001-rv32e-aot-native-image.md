...
Multiple embedded AOT modules are a deferred investigation. Adopting them
requires a new decision with measured metadata/import-resolution costs; it
does not require adopting a dynamic loader or separate application partition.
